...
public:
	...
	void set_value(const char* value) {
		...
		vfunc<set_value_fn>(this, 14)(this, value);
	}

	void set_value(float value) {
		using set_value_fn = void(__thiscall*)(void*, float);
		vfunc<set_value_fn>(this, 15)(this, value);
	}

	void set_value(int value) {
		using set_value_fn = void(__thiscall*)(void*, int);
		vfunc<set_value_fn>(this, 16)(this, value);
	}
...
public:
	c_convar* find_var(const char* convar_name) {
		...
		return vfunc<find_var_fn>(this, 16)(this, convar_name);
	}
